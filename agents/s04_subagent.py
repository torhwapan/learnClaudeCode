...
def run_subagent(prompt: str) -> str:
    ...
    if not sub_messages or sub_messages[0]["role"] != "system":
    ...
    for _ in range(30):  # safety limit
        ...
        # sub_messages.append({"role": "assistant", "content": msg.content, "tool_calls": msg.get('tool_calls')})
...
PARENT_TOOLS = CHILD_TOOLS + [
        ...
        "function": {
            ...
            "parameters": {
                "type": "object",
                "properties": {
                    "prompt": {"type": "string", "description": "The detailed instruction for the subagent"},
